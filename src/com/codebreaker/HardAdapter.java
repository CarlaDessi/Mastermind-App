...
public class HardAdapter extends ArrayAdapter<Guess> {

	public HardAdapter(Context context){  
		super(context, R.layout.hard_list_item);
	...
	public View getView(int pos, View convertView, ViewGroup parent){
		...
		if(v==null) {
			...
			v=vi.inflate(R.layout.hard_list_item, null);
		}
		...
		ImageView circle5=(ImageView) v.findViewById(R.id.circle5);
		...
		circle5.setImageResource(item.getColour(4).getImageId());
		...
		ImageView peg5=(ImageView) v.findViewById(R.id.peg5);
		...
		peg5.setImageResource(R.drawable.scoregrey);
		//setting the 5 pegs to grey as default
		...
		if (item.whiteCount==5){
			peg1.setImageResource(R.drawable.scorewhite);
			peg2.setImageResource(R.drawable.scorewhite);
			peg3.setImageResource(R.drawable.scorewhite);
			peg4.setImageResource(R.drawable.scorewhite);
			peg5.setImageResource(R.drawable.scorewhite);
		}
		...
		if(item.blackCount==5){
			peg1.setImageResource(R.drawable.scoreblack);
			peg2.setImageResource(R.drawable.scoreblack);	
			peg3.setImageResource(R.drawable.scoreblack);
			peg4.setImageResource(R.drawable.scoreblack);
			peg5.setImageResource(R.drawable.scoreblack);

			HardGame.sendScore(getContext());
