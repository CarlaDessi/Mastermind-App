...
public class MediumGame extends Activity implements OnClickListener, OnKeyListener {

	//initialising the counters
	public int buttonCount = 1;
	public int guessCount = 0;
	public static int scoreCount = 26;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mAdapter = new MediumAdapter(this);
	...
	public void sendGuess() {
		...
		if (guess4==null){
			...
			Guess guess = new Guess (new Colour[] {guess1, guess2, guess3, guess4}, solution);
			mAdapter.add(guess);
			...
			.setPositiveButton("Restart", new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int id) {
					Intent intent = new Intent(MediumGame.this, MediumGame.class);
					startActivity(intent);
				}
			})
			.setNegativeButton("Main Menu", new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int id) {
					MediumGame.this.finish();
				}
			});
