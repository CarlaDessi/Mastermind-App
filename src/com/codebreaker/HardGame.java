...
public class HardGame extends Activity implements OnClickListener, OnKeyListener {

	//initialising the counters
	public int buttonCount = 1;
	public int guessCount = 0;
	public static int scoreCount = 39;
	...
	public Colour guess4;
	public Colour guess5;
	...
	public Colour answer4;
	public Colour answer5;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		empty5 = (ImageView) findViewById(R.id.empty5);
		//linking the declared image view to the name


		mAdapter = new HardAdapter(this);
		...
		red.setOnClickListener(new View.OnClickListener() {    
			public void onClick (View v)   {   
				...
				case 3:  
					...
					break;
				case 4:  
					empty4.setImageResource(R.drawable.red);
					buttonCount++;
					guess4=Colour.RED;
					break;
				case 5:  
					empty5.setImageResource(R.drawable.red);
					buttonCount++;
					guess5=Colour.RED;
					break;
		...
		green.setOnClickListener(new View.OnClickListener() {    
			public void onClick (View v)   {
				...
				case 3:  
					...
					break;
				case 4:  
					empty4.setImageResource(R.drawable.green);
					buttonCount++;
					guess4=Colour.GREEN;
					break;
				case 5:  
					empty5.setImageResource(R.drawable.green);
					buttonCount++;
					guess5=Colour.GREEN;
					break;
		...
		blue.setOnClickListener(new View.OnClickListener() {    
			public void onClick (View v)   {   
				...
				case 3:  
					...
					break;
				case 4:  
					empty4.setImageResource(R.drawable.blue);
					buttonCount++;
					guess4=Colour.BLUE;
					break;
				case 5:  
					empty5.setImageResource(R.drawable.blue);
					buttonCount++;
					guess5=Colour.BLUE;
					break;
		...
		pink.setOnClickListener(new View.OnClickListener() {    
			public void onClick (View v)   {   
				...
				case 3:  
					...
					break;
				case 4:  
					empty4.setImageResource(R.drawable.pink);
					buttonCount++;
					guess4=Colour.PINK;
					break;
				case 5:  
					empty5.setImageResource(R.drawable.pink);
					buttonCount++;
					guess5=Colour.PINK;
					break;
		...
		orange.setOnClickListener(new View.OnClickListener() {    
			public void onClick (View v)   {   
				...
				case 3:  
					...
					break;
				case 4:  
					empty4.setImageResource(R.drawable.orange);
					buttonCount++;
					guess4=Colour.ORANGE;
					break;
				case 5:  
					empty5.setImageResource(R.drawable.orange);
					buttonCount++;
					guess5=Colour.ORANGE;
					break;
	...
	public void sendGuess() {
		...
		if (guess5==null){
			...
			Guess guess = new Guess (new Colour[] {guess1, guess2, guess3, guess4, guess5}, solution);
			mAdapter.add(guess);
			...
			.setPositiveButton("Restart", new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int id) {
					Intent intent = new Intent(HardGame.this, HardGame.class);
